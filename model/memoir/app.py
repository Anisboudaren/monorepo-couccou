...
class PineconeKnowledgeBase:
    ...
    def init_pinecone(self):
        try:
            ...
            # Check pinecone version and use appropriate initialization
            if pinecone.__version__.startswith('2.'):
                # Initialize for Pinecone v2.x
                print("Using Pinecone v2.x initialization")
                ...
                # Initialize LangChain's Pinecone vectorstore for v2.x
                ...
                # Initialize for Pinecone v3.x
                print("Using Pinecone v3.x initialization")
                ...
                # Initialize LangChain's Pinecone vectorstore for v3.x with explicit index instance
                self.vector_store = Pinecone(
                    index=index,
                    embedding=self.embeddings,
                    text_key="text"  # Adjust this if your metadata field is different
                )
